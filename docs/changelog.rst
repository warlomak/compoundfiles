...
Release 0.4 (2026-02-01) - Fork Release
========================================

* Added full writing support with compliant Red-Black tree directory structure
* Added editing capabilities (rename, delete, add streams/storages)
* Enhanced validation and error handling for corrupted files
* Improved memory management for large files and MiniFAT streams
* Better compatibility with different CFB versions and edge cases
* Fixed directory tree handling and improved validation with real-world files
